...
class Test_001_Login(BaseClass):
    ...
    def test_login(self):
        ...
        try:
            self.lp.click_Group_Discussion()
            print("Group Discussion on Most_Expensive_Pizza link is clicked")
            act_title = self.driver.title
            if act_title == "15.2 Group Discussion on Most Expensive Pizza":
                assert True
                print(act_title, "Page is opened")
            else:
                assert False
        except NoSuchElementException:
            print("Group Discussion on Most_Expensive_Pizza link is not found")
        time.sleep(20)
...
class Test_003_Login(BaseClass):
    baseURL = "https://learn.datascience.berkeley.edu/ap/courses/262/sections/252816a5-7896-4046-a3bf-a86b8e2d1216/coursework/module/2e882bba-829d-4b2a-84a3-05e7b1cc9c53/segment/795d19a2-cb70-448c-8420-26b265299958"
    username = "student6"
    password = "-mF9SF^g}{&S1O"
...
class Test_006_Login(BaseClass):
    ...
    def test_login(self):
        ...
        try:
            self.lp.click_GD_Create_New_Post()
            print("click_Create_New_Post button is clicked")
        except NoSuchElementException:
            print("click_Create_New_Post button is not found")
